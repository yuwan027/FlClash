...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(statusCode) => "获取用户信息失败: ${statusCode}";

  static String m1(count) => "已选择 ${count} 项";

  static String m2(balance) => "您的余额: ${balance} CNY";

  static String m3(commission) => "您的佣金: ${commission} CNY";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "balanceTransfer": MessageLookupByLibrary.simpleMessage("余额转换"),
    ...
    "enterValidAmount": MessageLookupByLibrary.simpleMessage("请输入有效的金额"),
    ...
    "loginFailedEmptyUserInfo": MessageLookupByLibrary.simpleMessage("用户信息为空"),
    "loginFailedGetUserInfo": MessageLookupByLibrary.simpleMessage("获取用户信息失败"),
    "loginFailedGetUserInfoRetry": MessageLookupByLibrary.simpleMessage(
      "获取用户信息失败，请重试",
    ),
    "loginFailedGetUserInfoStatus": m0,
    "loginFailedNetwork": MessageLookupByLibrary.simpleMessage("登录失败，网络问题"),
    "loginRedirecting": MessageLookupByLibrary.simpleMessage("正在跳转..."),
    "loginSendingRequest": MessageLookupByLibrary.simpleMessage("正在发送登录请求..."),
    ...
    "transfer": MessageLookupByLibrary.simpleMessage("转换"),
    "transferFailed": MessageLookupByLibrary.simpleMessage("余额转换失败"),
    "transferSuccess": MessageLookupByLibrary.simpleMessage("余额转换成功"),
    ...
    "unitYuan": MessageLookupByLibrary.simpleMessage("单位：元"),
    ...
    "usedDownload": MessageLookupByLibrary.simpleMessage("已用下载"),
    "usedUpload": MessageLookupByLibrary.simpleMessage("已用上传"),
